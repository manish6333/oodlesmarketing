...
<section id="blog_single_body">
   <div class="single_blog_title_div">
      <div class="container">
         <div>
            <h2 class="single_blog_title_main"><?php echo get_the_title();?></h2>
         </div>
               ...
               <div>
                  ...
                  <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink();?>%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">
                        <div class="share_post_blog for_face_book">
                           <emclass="fa fa-facebook common_icon_css face_book"></em>
                           <span class="st-label">
                           Facebook</span>
                        </div>
                     </a>
                     <a href="https://twitter.com/intent/tweet?url=<?php the_permalink();?>" target="_blank">
                        <div class="share_post_blog for_twitter">
                           <emclass="fa fa-twitter common_icon_css twi_tter"></em>
                           <span class="st-label">
                           twitter</span>
                        </div>
                     </a>
                     <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php the_permalink();?>" target="_blank">
				          <div class="share_post_blog for_google">
				           <emclass="fa fa-linkedin-square common_icon_css goo_gle"></em>
 ...
 <?php
                ...
                // }
                  ...
                  //for use in the loop, list 5 post titles related to first tag on current post
					...
					if( !empty( $first_tag ) ) { 
                      ...
                      if( $my_query->have_posts() ) {
                      while ($my_query->have_posts()) : $my_query->the_post(); ?>
                  <div class="single_blog_sidemenu_sec">
                     <div>
                        <h2 class="single_blog_title_side_home"><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php the_title(); ?>
						</a></h2>
                     </div>
                     <div class="single_display_flex_name">
                        <h4 class="single_blog_author_side_home"><?php the_author();?> | </h4>
                        <h4 class="single_blog_date_side_home"><?php echo get_the_date('jS F Y');?></h4>
                     </div>
                  </div>
				  <?php
                   endwhile;
            ...
            <ul class="blog-list">
                <li>
                    ...
                    <ul class="publish">
                        <li><a href="<?php the_permalink(); ?>"><emclass="glyphicon glyphicon-calendar"></em><?php echo get_the_date("F d, Y",$postid );?></a></li>
                   
                        <li>
                            <span id="category" style="display: none;"><?php the_terms( $postid, 'relevant_work_category', '', ", ", '' ); ?></span>


                            <a href="<?php echo get_comments_link( $postid ); ?>"><emclass="glyphicon glyphicon-comment"></em>
